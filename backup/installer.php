...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20230520_crossimport_f479f31293d6994a1842_20230520184911_archive.zip';
        const ARCHIVE_SIZE       = '18224296';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'f479f31-20184911';
        const SECONDARY_PACKAGE_HASH = '77f5f28-20184911';
        const VERSION            = '1.5.4';
